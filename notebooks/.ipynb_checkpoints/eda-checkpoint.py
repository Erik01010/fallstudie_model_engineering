 ...
 "cells": [
  {
   ...
   "id": "a9cb2f7d-6fc5-4ffb-b518-111d570dd7a7",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "173156d2-e1b4-447b-b683-b74e07b3c207",
   "metadata": {},
   "outputs": [],
   "source": [
    "df.head(10)"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "4588358a-4f61-4cef-a057-67e0ce602050",
   "metadata": {},
   "outputs": [],
   "source": [
    "df.info()"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "59234503-7948-44f1-ba1f-e54d4706976f",
   "metadata": {},
   "outputs": [],
   "source": [
    "df.describe()"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "f6c2c7df-3b5a-4fb4-8046-046fa0bd9389",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "ee57cd5f-159a-43f9-94dd-940f7f1d3f1a",
   "metadata": {},
   "outputs": [],
   "source": [
    "# Verteilung Amount\n",
    "plt.figure(figsize=(14, 10))\n",
    "plt.hist(df[\"amount\"], bins=100, edgecolor=\"black\", alpha=0.5, color=\"blue\", label=\"Betrag\")\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "11208e86-450d-47a0-a7fb-4cc91f4702d5",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "98a54f95-d512-4e31-b1f4-aea132adca5a",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "0db9c156-b9ec-436c-9092-1916e819e848",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "c96464b9-8d97-4a19-81f3-964462020083",
   "metadata": {},
   "outputs": [],
   "source": [
    ...
    "        tick_positions = range(0, len(stats), 7)\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "a54a5da6-e857-4a7d-9820-6aaa110df54a",
   "metadata": {},
   "outputs": [],
   "source": [
    ...
    "\n",
    "# 1. Stündliche Verteilung pro Feature\n",
    ...
    "    ax.set_ylim(0, 1)\n",
    "\n",
    "# 3. Tägliche Anteile der Kategorien\n",
    ...
    "\n",
    "daily_dist_pct.plot(kind=\"area\", stacked=True, ax=ax_bottom, alpha=0.7, colormap=\"tab10\")\n",
    ...
    "plt.savefig(\"../diagrams/categorical_temporal_analysis.png\", dpi=300, bbox_inches=\"tight\")\n",
    "plt.show()"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "c77af782-5d47-4333-be3f-817d79ea7703",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "1ad73da9-c331-4e87-858c-85a4b13c8d6c",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "a2801ea3-88ee-4547-bce6-d6b29bf012c8",
   "metadata": {},
   "outputs": [],
   "source": [
    "df[df[\"amount\"] > 200][\"success\"].mean()"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "981fd030-e158-4cb9-a175-27859bb6c60d",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "a67b5ffa-10d2-4d5d-a5ec-dd0e9cbc02c2",
   "metadata": {},
   "outputs": [],
   "source": [
    "# Erfolgsquote und Anzahl Transaktionen nach Betragskategorie\n",
